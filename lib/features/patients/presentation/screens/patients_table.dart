...
class _DataTableDemoState extends State<DataTableDemo> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Scrollbar(
        // Add a scrollbar to the body of the scaffold
        child: ListView(
          ...
          children: [
            PaginatedDataTable(
              header:
                  Text('Nutrition'), // Set the header text of the data table
              ...
              onSelectAll: _dessertsDataSource!
                  ._selectAll, // Set the select all callback of the data table
              columns: [
                DataColumn(
                  label: Text(
                ...
                DataColumn(
                  label:
                      Text('Carbs (g)'), // Set the label of the fourth column
                  numeric: true,
                  onSort: (columnIndex, ascending) => _sort<num>(
                      (d) => d.carbs,
                      columnIndex,
                ...
                DataColumn(
                  label:
                      Text('Protein (g)'), // Set the label of the fifth column
                  numeric: true,
                  onSort: (columnIndex, ascending) => _sort<num>(
                      (d) => d.protein,
                      columnIndex,
                ...
                DataColumn(
                  label:
                      Text('Sodium (mg)'), // Set the label of the sixth column
                  numeric: true,
                  onSort: (columnIndex, ascending) => _sort<num>(
                      (d) => d.sodium,
                      columnIndex,
                ...
                DataColumn(
                  label:
                      Text('Calcium %'), // Set the label of the seventh column
                  numeric: true,
                  onSort: (columnIndex, ascending) => _sort<num>(
                      (d) => d.calcium,
                      columnIndex,
